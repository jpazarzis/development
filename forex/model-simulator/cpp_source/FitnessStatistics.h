...
class FitnessStatistics final
{
    ...
    public:
        ...
        inline double max_draw_down() const
        {
            return _max_draw_down;
        }

        inline double account_balance() const
        {
            return _account_balance;
        }

        inline double absolute_low() const
        {
            return _absolute_low;
        }

        inline double absolute_high() const
        {
            return _absolute_high;
        }
        ...
        inline int number_of_orders() const
        {
            return _number_of_orders;
        }

        inline int expired_trades() const
        {
            return _expired_trades;
        }

        inline int winning_expired_trades() const
        {
            return _winning_expired_trades;
        }

        inline int losing_expired_trades() const
        {
            return _losing_expired_trades;
        }

        inline int winning_trades() const
        {
            return _winning_trades;
        }

        inline int lossing_trades() const
        {
